				...
				<div class="col-xs-12 align_center">
					<div class="btn-group">
						...
						<a class="btn btn-sm btn-default arrow">
							Page :
							<input type="text" value="<?php echo $next; ?>" id="<?php echo $this->table; ?>_go_to_field" class="go_to_field" onkeydown="if(event.keyCode == 13){ go_to('<?php echo $this->table; ?>', '<?php echo $this->request; ?>', '<?php echo $pages; ?>'); }">
							of <?php echo $pages; ?>
						</a>
